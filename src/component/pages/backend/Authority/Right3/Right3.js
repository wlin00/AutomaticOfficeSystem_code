...
const Right3 = (e) => {
    ...
    const { Search } = Input
    const { Option } = Select
    const addType = '人事审批' //要添加的人员的权限类型
    ...
    const handleOk2 = e => {
        setVisible2(false)
        console.log(delName)
        axios.delete(`/AutomaticOfficeSystem/approvalManagement/api/v1/approvalUser?permission=${'3'}&userUsername=${delName}`)
            .then((data) => {
         ...
         <div className='Right3'>
            <div>
                <Modal
                    ...
                    destroyOnClose={true}
                >
                    <div className='Right3-wrap__div'>
                        <Text style={{ fontSize: 'normal' }} className="Right3-wrap__text">职务</Text>
                        <Input
                            className="Right3-wrap__input"
                            placeholder="请输入审批权限"
                            value={addType}
                            disabled={true}
                    ...
                    <div className='Right3-wrap__div'>
                        <Text style={{ fontSize: 'normal' }} className="Right3-wrap__text">用户名</Text>
                        <Input
                            className="Right3-wrap__input"
                            placeholder="请输入用户名"
                            value={username}
            ...
            <ul className='Right3-ul'>
                <li className='Right3-ul__li Right3-ul__li--posi'   >
                    <Button onClick={showModal} style={{ border: "none" }}>
                        <Icon className='Right3-ul__li--icon' type="plus-square" />
                        <Text className='addText' style={{ position: 'relative', left: '5px' }}>添加成员</Text>
                    </Button>
                </li>

            </ul>
            <div className='Right3-wrap'>
...
export default React.memo(Right3)
